...
public class SquareRootDenestTest {
    ...
    public void testNestedDenesting() {
        Constructible series = ZInteger.ONE.add(SquareRoot.of(2)).add(SquareRoot.of(ZInteger.ONE.add(SquareRoot.of(2))))
                .add(SquareRoot.of(SquareRoot.of(2).add(SquareRoot.of(3))));
        assertEquals(series, SquareRoot.of(series.squared()));
    }
