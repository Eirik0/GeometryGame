...
public class SeriesTest {
    public static void assertContainsAll(List<Constructible> expected, List<SquareRoot> actual) {
        ...
        assertTrue("Missing: " + Arrays.toString(expectedCopy.toArray()) + " Unexpected: " + Arrays.toString(actualCopy.toArray()),
                expectedCopy.isEmpty() && actualCopy.isEmpty());
    }
    ...
    public void testSignum_SixRootsSmallSum() {
        ...
        assertEquals(1, SquareRoot.of(3).add(SquareRoot.of(5)).add(SquareRoot.of(11)).subtract(SquareRoot.of(2)).subtract(SquareRoot.of(7))
                .subtract(SquareRoot.of(10)).signum());
    }
    ...
    public void testDivideSeriesIsRationalSeries() {
        CRational quotient = (CRational) ZInteger.ONE.add(SquareRoot.of(2)).add(SquareRoot.of(3)).add(SquareRoot.of(6))
                .divide(ZInteger.TWO.add(SquareRoot.of(8)));
        Series numerator = (Series) quotient.numerator;
    ...
    public void testToString() {
        assertEquals("1+" + SquareRoot.SQRT_CHAR + "(2)-" + SquareRoot.SQRT_CHAR + "(3)",
                ZInteger.ONE.add(SquareRoot.of(2)).subtract(SquareRoot.of(3)).toString());
