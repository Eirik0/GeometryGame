...
public class CCircleTest {
	...
	public void testCircle_TwoPoints() {
		checkEqualIntersections(new IntersectionSet(CPoint.newPoint(6, 8), CPoint.newPoint(7, 7)), radiusFiveCircleAt(3, 4).findIntersection(radiusFiveCircleAt(10, 11)));
	}

	@Test
	public void testCircle_TwoPoints_Horizontal() {
		checkEqualIntersections(new IntersectionSet(CPoint.newPoint(0, 8), CPoint.newPoint(6, 8)), radiusFiveCircleAt(3, 4).findIntersection(radiusFiveCircleAt(3, 12)));
	}
